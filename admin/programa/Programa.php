    ...
    static function insetarPrograma($pNombre, $pFecha, $pAcreditacion,$pNumAdmitidos,$pIdfacultad)
    {
        ...
        public function lista_programa($tabla)
        {
            ...
            while ($row = mysql_fetch_row($result)) 
                {
                echo "<tr id=resul><td>$row[0]</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td>". "<td><a href=../programa/procesar_programa.php?req_col=eliminar&id=".$row[0]."><img src=../../img/Colegio/elmn.png width=25px heigt=25px /></a>" 
