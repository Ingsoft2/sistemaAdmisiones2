...
<html>
  ...
  <section id="gallery">
  	<div class="container">
        ...
        <li><img src="images/grado.jpg" alt=""></li>
        <li><img src="images/slide5.jpg" alt=""></li>
        <li><img src="images/slide1.jpg" alt=""></li>
        <li><img src="images/universidad.jpg" alt=""></li>
        <li><img src="images/Captura.JPG" alt=""></li>
      </ul>
  	</div>
  </section>
  <!-- /#gallery -->
